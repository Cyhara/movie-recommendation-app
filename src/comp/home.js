...
const Home = ({detail, detailData, close, detailClose, showDetail}) => {
    ...
    return (
        <>
            ...
            <div className='main_container' style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/img/banner6.jpeg)`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'}}>
